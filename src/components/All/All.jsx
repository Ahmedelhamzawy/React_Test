...
export default class All extends Component {
  ...
  getAllData = async () => {
    ...
    this.setState({
      allProducts: products.data.categories[0].products,
    });
  };
    ...
    return (
      <>
        <div className={styles.all_Products}>
          ...
          <div className={styles.category_Title}>All</div>
            ...
            {this.state.allProducts.map((value) => {
              return (
                ...
                <div className={styles.product} key={value.id}>
                  ...
                  {value.inStock ? (
                    <>
                      <Link to={{pathname: `/ProductPurchase/${value.id}`,}}>
                        <img className={styles.product_img} src={value.gallery[0]} alt=""/>
                      </Link>
                        ...
                        if (price.currency.symbol == currency) {
                          return (
                            <>
                              ...
                              <div key={price.currency.symbol } className={styles.product_price}>
                        ...
                        if (price.currency.symbol == currency) {
                          return (
                            <>
                              ...
                              <div key={price.currency.symbol} className={styles.product_price_outofstock}>
                                {currency} {price.amount}
                              </div>
